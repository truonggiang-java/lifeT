...
public class StudentService {
	...
	public List<StudentAllDto> findAllStudent(){
	...
	public List<StudentNumberDto> findNumberStudent(Integer fromAge,Integer toAge,String name,String departmentId,String classId,String gender){
		return studentRepository.findNumberStudent(fromAge,toAge,name,departmentId,classId,gender);
	}
